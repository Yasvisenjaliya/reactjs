...
const Product = () => {
  return (
    <div className=" text-white">
      <div>
        <h1 className=" lg:text-5xl md:text-5xl xl:text-5xl max-sm:text-3xl sm:text-3xl font-bold xl:pl-[30%] lg:pl-[30%] md:pl-[15%] max-sm:pl-[5%] xl:pr-[30%] lg:pr-[30%] md:pr-[15%] max-sm:pr-[5%] mt-16 ">
          Ecommerce builder for small and medium businesses
        </h1>
        <p className="xl:pl-[30%] lg:pl-[30%] md:pl-[15%] max-sm:pl-[5%] xl:pr-[30%] lg:pr-[30%] md:pr-[15%] max-sm:pr-[5%] mt-10 text-2xl xl:text-2xl sm:text-xl ">
      ...
      <div className=" xl:ml-80 max-sm:ml-5 mt-32 xl:flex lg:ml-52  md:flex-row lg:flex sm:ml-16 sm:flex-col">
        <div>
          <img src="./assets/image1.jpg"  className="xl:w-[60%]  animate-bounce" />
        ...
        <div>
          <img src="./assets/image2.jpg" className=" xl:w-[60%] xl:h-[42.5%] lg:h-[48%] md:mt-10 sm:h-[50%] animate-bounce" />
